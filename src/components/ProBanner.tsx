...
export function ProBanner() {
  ...
  if (settings?.enableCodeFighterPro || userBudget) {
    return (
      <div className="mt-6 max-w-2xl mx-auto">
        <ManageCodeFighterProButton />
      </div>
    );
  }
  ...
  return (
    <div className="mt-6 max-w-2xl mx-auto">
      ...
      <SetupCodeFighterProButton />
    </div>
  );
}

export function ManageCodeFighterProButton() {
  return (
    <Button
      variant="outline"
      size="lg"
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://academy.codefighter.dev/subscription",
        );
      }}
    >
...
export function SetupCodeFighterProButton() {
  return (
    <Button
      variant="outline"
      size="lg"
    ...
    >
      <KeyRound aria-hidden="true" />
      Already have Code Fighter Pro? Add your key
    </Button>
  );
}
...
export function AiAccessBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.codefighter.dev/pro?utm_source=code-fighter-app&utm_medium=app&utm_campaign=in-app-banner-ai-access",
        );
      }}
    >
      <div
      ...
      <div className="relative z-10 text-center flex flex-col items-center gap-0.5 sm:gap-1 md:gap-1.5 px-4 md:px-6 pr-6 md:pr-8">
        <div className="mt-0.5 sm:mt-1 flex items-center gap-2 sm:gap-3 justify-center">
          ...
          <button
            type="button"
            aria-label="Subscribe to Code Fighter Pro"
...
export function SmartContextBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.codefighter.dev/pro?utm_source=code-fighter-app&utm_medium=app&utm_campaign=in-app-banner-smart-context",
        );
      }}
    >
      <div
      ...
      <div className="relative z-10 px-4 md:px-6 pr-6 md:pr-8">
        <div className="mt-0.5 sm:mt-1 flex items-center gap-2 sm:gap-3 justify-center">
          ...
          <button
            type="button"
            aria-label="Get Code Fighter Pro"
...
export function TurboBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.codefighter.dev/pro?utm_source=code-fighter-app&utm_medium=app&utm_campaign=in-app-banner-turbo",
        );
      }}
    >
      <div
