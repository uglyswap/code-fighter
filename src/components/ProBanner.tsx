...
export function AiAccessBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.codefighter.dev/pro?utm_source=dyad-app&utm_medium=app&utm_campaign=in-app-banner-ai-access",
        );
      }}
    >
      <div
...
export function SmartContextBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.codefighter.dev/pro?utm_source=dyad-app&utm_medium=app&utm_campaign=in-app-banner-smart-context",
        );
      }}
    >
      <div
...
export function TurboBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.codefighter.dev/pro?utm_source=dyad-app&utm_medium=app&utm_campaign=in-app-banner-turbo",
        );
      }}
    >
      <div
