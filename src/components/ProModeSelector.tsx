  ...
  return (
    <Popover>
      <Tooltip>
        ...
        <TooltipContent>Configure Code Fighter Pro settings</TooltipContent>
      </Tooltip>
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <h4 className="font-medium flex items-center gap-1.5">
              <Sparkles className="h-4 w-4 text-primary" />
              <span className="text-primary font-medium">Code Fighter Pro</span>
            </h4>
          ...
          {!hasProKey && (
            <div className="text-sm text-center text-muted-foreground">
              <Tooltip>
                ...
                <TooltipContent>
                  Visit codefighter.dev/pro to unlock Pro features
                </TooltipContent>
              </Tooltip>
            </div>
          )}
