...
interface CodeFighterMcpToolCallProps {
  node?: any;
  children?: React.ReactNode;
}

export const CodeFighterMcpToolCall: React.FC<CodeFighterMcpToolCallProps> = ({
  node,
  children,
}) => {
  ...
  const prettyJson = useMemo(() => {
    ...
    try {
      ...
      console.error("Error parsing JSON for code-fighter-mcp-tool-call", e);
      return raw;
    }
  }, [expanded, raw]);
