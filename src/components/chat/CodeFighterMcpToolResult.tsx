...
interface CodeFighterMcpToolResultProps {
  node?: any;
  children?: React.ReactNode;
}

export const CodeFighterMcpToolResult: React.FC<CodeFighterMcpToolResultProps> = ({
  node,
  children,
}) => {
  ...
  const prettyJson = useMemo(() => {
    ...
    try {
      ...
      console.error("Error parsing JSON for code-fighter-mcp-tool-result", e);
      return raw;
    }
  }, [expanded, raw]);
