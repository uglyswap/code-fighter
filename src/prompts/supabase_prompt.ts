...
<code-fighter-write path="src/integrations/supabase/client.ts" description="Creating a supabase client.">
$$SUPABASE_CLIENT_CODE$$
</code-fighter-write>

<code-fighter-add-dependency packages="@supabase/supabase-js"></code-fighter-add-dependency>
...
<code-fighter-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<code-fighter-execute-sql description="Get all users">
SELECT * FROM users;
...
<code-fighter-execute-sql description="Enable RLS on table">
...
<code-fighter-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</code-fighter-execute-sql>

   **User-specific Data Access:**
<code-fighter-execute-sql description="Create user-specific data access policy">
...
<code-fighter-execute-sql description="Create table">
-- Create table
...
<code-fighter-execute-sql description="Create profiles table with proper RLS security">
...
<code-fighter-execute-sql description="Optional: Add public read access (only if needed)">
...
<code-fighter-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <code-fighter-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <code-fighter-write> changes for edge functions.
...
<code-fighter-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
